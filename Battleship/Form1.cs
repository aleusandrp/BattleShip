...
namespace Battleship
{
    public partial class Form1 : Form
    {
        ...
        private void Buffer(int x, int y, PictureBox[,] Field, Ship[,] Ships)
        {
            // углы точки
            if (y != 0 && x != 0)
            ...
            for (int x = 0; x < Col; x++)
            {
                for (int y = 0; y < Row; y++)
                {
                    if (CompShips[x, y] != null)
                        ...
                        {
                            Buffer(x, y, CompField, CompShips);
        ...
        public void Shot()
        {
            while (true)
            {
                Gx = rand.Next(0, 10);
                Gy = rand.Next(0, 10);
                if (UserField[Gx, Gy].Image == Images[0] || UserField[Gx, Gy].Image == Images[3])
                    break;
            }
                            ...
                            if (Gx - 1 >= 0)
                            {
                                ...
                                if (UserShips[Gx - 1, Gy] != null)
                                {
                                    ...
                                    if (!UserShips[Gx - 1, Gy].CheckLife())
                                    {
                                        ...
                                        Buffer(Gx, Gy, UserField, UserShips);
                                        Buffer(Gx - 1, Gy, UserField, UserShips);
                                        state = 0;
                                    }
                                    else
                                    {
                                        UserField[Gx - 1, Gy].Image = Images[2];
                                        movevect = 1;
                                        attackside = 1;
                                        state = 2;
                                    }
                                ...
                                {
                                    UserField[Gx - 1, Gy].Image = Images[1];
                                    move = true;
                                }
                            }
                            else
                            ...
                            if (Gy - 1 >= 0)
                            {
                                ...
                                if (UserShips[Gx, Gy - 1] != null)
                                {
                                    ...
                                    if (!UserShips[Gx, Gy - 1].CheckLife())
                                    {
                                        ...
                                        Buffer(Gx, Gy, UserField, UserShips);
                                        Buffer(Gx, Gy - 1, UserField, UserShips);
                                        state = 0;
                                    }
                                    else
                                    {
                                        UserField[Gx, Gy - 1].Image = Images[2];
                                        movevect = 0;
                                        attackside = 0;
                                        state = 2;
                                    }
                                ...
                                {
                                    UserField[Gx, Gy - 1].Image = Images[1];
                                    move = true;
                                }
                            }
                            else
                ...
                case 0:
                    {
                        if(attackside == 1)
                        {
                            for (int i = 1; i < 4; i++)
                            {
                                if (Gy + i <= 9)
                                {
                                    if (UserShips[Gx, Gy + i] != null) 
                                    {
                                        Buffer(Gx, Gy + i, UserField, UserShips);
                                        UserField[Gx, Gy + i].Image = Images[4];
                ...
                case 1:
                    {
                        if (attackside == 1)
                        {
                            for (int i = 1; i < 4; i++)
                            {
                                if (Gx - i >= 0)
                                {
                                    if (UserShips[Gx - i, Gy] != null)
                                    {
                                        Buffer(Gx - i, Gy, UserField, UserShips);
                                        UserField[Gx - i, Gy].Image = Images[4];
